...
print( "시작 : " , startb,  "달러", startu,"원" , "합", startb * dollor[0] + startu," 원")
print("최종 : ",binanceSeed, "달러" , upSeed, "원", "합", binanceSeed * dollor[-1] + upSeed , "원")
print("이득 : ", (binanceSeed * dollor[-1] + upSeed) - (startb * dollor[0] + startu),"원")
